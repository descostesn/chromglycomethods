...
filepathvec <- c("data/NPC_1b_atac_NoDox_rep1_peaks.bed",
"data/NPC_1b_atac_NoDox_rep2_peaks.bed",
"data/NPC_1b_atac_NoDox_rep3_peaks.bed",
"data/NPC_1b_atac_Dox_rep1_peaks.bed",
"data/NPC_1b_atac_Dox_rep2_peaks.bed",
"data/NPC_1b_atac_Dox_rep3_peaks.bed")
outputfile <- "results/NPC1bNoDox_vs_Dox.gtf"
inputformat <- "bed"
analysisname <- "unionNPCatac"
featurename <- "peak"
